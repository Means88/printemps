...
const copy = {
 zh: {eyebrow:'LOCAL STEM SEPARATION',headline:'从一首歌，听见每个声部。',lead:'在你的电脑上分离人声、鼓、贝斯、吉他等 53 种声部，逐轨试听、剪辑、导出。音频与结果只留在本机。',other:'其它平台',features:'功能',downloads:'下载',downloadsSub:'安装包来自 GitHub Releases，页面自动读取最新版本。',privacy:'隐私与本地处理',privacyBody:'分析与分离全部在本机完成，音频、剪辑和结果只存放在应用私有目录，导出的文件是独立副本。联网仅用于按需下载模型权重（Hugging Face）与检查应用更新。',navFeatures:'功能',navDownload:'下载',navPrivacy:'隐私',toggle:'EN',get:'下载',releases:'全部版本',notes:'发布说明',license:'许可',loading:'正在读取最新版本…',unavailable:'暂时无法读取发布信息，请前往 GitHub Releases 下载。',noAsset:'该平台尚无安装包',
  f:[['53 种声部按需下载','只下载你要的模型，缓存可管理。BS-Roformer Mega v1。'],['非破坏式剪辑','分割、裁剪、只分离选中的片段；结果保留时间轴位置。'],['逐轨试听','原始/分轨互斥试听、S/M、增益、循环、节拍器与 BPM/调性分析。'],['独立导出','WAV/FLAC 24-bit；按剪辑范围或按项目时间轴补空白导出。']],

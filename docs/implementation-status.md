...
| Windows/macOS/Linux | native build 工作流；macOS arm64 测试包；Linux x64 容器内 AppImage 及包内分析通过 | 3371b17 三平台 CI 全绿；6b453e5 新一轮运行中。Windows/Linux GUI、安装/卸载与升级待验 |
...
1. 完成最新工作流 35480556644 的终态核对，不重复触发同一验证。
